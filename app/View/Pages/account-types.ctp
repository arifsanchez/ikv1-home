    ...
    <div class="row-fluid" align="center">
        <div class="pricing_table pricing_four"><!-- BEGIN TABLE CONTAINER -->
            ...
            <div class="pricing_hover_area"><!-- BEGIN HOVER AREA -->
                ...
                <!-- BEGIN MICRO CONTENT COLUMN -->
                <ul class="pricing_column gradient_red">
                    <li class="pricing_header1">Micro</li>
                    ...
                    <li class="even" data-table="Min Lot">0.01 lot ~ $0.01</li>
                    <li class="odd" data-table="Min Step">0.01</li>
                    

                    <li class="pricing_footer"><a href="http://support.iktrust.com/downloads/files/35-view/download" class="pricing_button">Open Micro Account</a></li>
                </ul>
                <!-- END MICRO CONTENT COLUMN -->
                
                <!-- BEGIN FIRST CONTENT COLUMN -->
                <ul class="pricing_column gradient_blue">
                    <li class="pricing_header1">Mini</li>
                    <li class="pricing_header2"><span>Capital From&nbsp;</span>$10</li>
                    <li class="odd" data-table="Spread">Fixed &amp; Flexible, from 3 pip(s)</li>
                    <li class="even" data-table="Pricing Decimals">(EurUsd) 4 Decimals, 5 Decimals</li>
                    <li class="odd" data-table="Leverage">1:100, 1:200, 1:500, 1:1000</li>
                    <li class="even" data-table="Symbols">Forex &amp; Precious Metals</li>
                    ...
                    <li class="even" data-table="Min Lot">0.01 lot ~ $0.10</li>
                    <li class="odd" data-table="Min Step">0.01</li>
                ...
                <ul class="pricing_column gradient_green">
                    ...
                    <li class="pricing_header2"><span>Capital From&nbsp;</span>$1,000</li>
                    ...
                    <li class="even" data-table="Swap-Free Acc (Islamic)">YES</li>
                    <li class="odd" data-table="Contract Size">100,000</li>
                    <li class="even" data-table="Min Lot">0.10 lot ~ $1.00</li>
                    <li class="odd" data-table="Min Step">0.01</li>
                ...
                <ul class="pricing_column gradient_yellow">
                    ...
                    <li class="even" data-table="Swap-Free Acc (Islamic)">YES</li>
                    <li class="odd" data-table="Contract Size">100,000</li>
                    <li class="even" data-table="Min Lot">1.00 lot ~ $10.00</li>
