...
<div class="container_representatives">
	...
	<section class="representatives_page">
	    ...
	    <article class="breadcrumb">
	   	...
	   	<div class="row-fluid">
            <section id="page-sidebar" class="span9">
									    ...
									    <div class="tab-content">
									    	...
									    	<div class="tab-pane" id="state_malay">
									    		...
									    		<div class="row-fluid">
									    			<div class="span6 well">
														...
														<div>Web :  <a href="http://www.iktrust.my">www.iktrust.my</a></div>
									    	...
									    	<div class="tab-pane" id="state_philip">
									    		...
									    		<div class="span12">
													...
													<div>Web :  <a href="http://www.iktrustphilippines.com" >www.iktrustphilippines.com</a></div>
            ...
            <!--sidebar-->
            <div class="span3">
                <?php echo $this->element('twitter_widget'); ?>
            </div>
